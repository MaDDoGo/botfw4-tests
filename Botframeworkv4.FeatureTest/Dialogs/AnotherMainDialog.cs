...
using Botframeworkv4.FeatureTest.Cards;

namespace Botframeworkv4.FeatureTest.Dialogs
{
    public class AnotherMainDialog : ComponentDialog
    {
        protected readonly ILogger _logger;

        public AnotherMainDialog(ILogger<MainDialog> logger)
